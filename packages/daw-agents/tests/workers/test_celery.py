...
class TestCeleryConfig:
    ...
    def test_celery_config_default_values(self) -> None:
        ...
        from daw_agents.workers.celery_app import CeleryConfig
...
class TestQueueDefinitions:
    ...
    def test_planner_queue_defined(self) -> None:
        ...
        from daw_agents.workers.celery_app import QUEUE_PLANNER
    ...
    def test_executor_queue_defined(self) -> None:
        ...
        from daw_agents.workers.celery_app import QUEUE_EXECUTOR
    ...
    def test_validator_queue_defined(self) -> None:
        ...
        from daw_agents.workers.celery_app import QUEUE_VALIDATOR
    ...
    def test_default_queue_defined(self) -> None:
        ...
        from daw_agents.workers.celery_app import QUEUE_DEFAULT
...
class TestRetryPolicy:
    ...
    def test_retry_policy_has_max_retries(self) -> None:
        ...
        from daw_agents.workers.celery_app import RetryPolicy
...
class TestCeleryApp:
    ...
    def test_celery_app_exists(self) -> None:
        ...
        from daw_agents.workers.celery_app import celery_app
...
class TestTaskDefinitions:
    ...
    def test_run_planner_task_exists(self) -> None:
        ...
        from daw_agents.workers.tasks import run_planner
    ...
    def test_run_executor_task_exists(self) -> None:
        ...
        from daw_agents.workers.tasks import run_executor
    ...
    def test_run_validator_task_exists(self) -> None:
        ...
        from daw_agents.workers.tasks import run_validator
...
class TestCeleryAppFactory:
    ...
    def test_create_celery_app_returns_app(self) -> None:
        ...
        from daw_agents.workers.celery_app import create_celery_app
    ...
    def test_create_celery_app_with_custom_config(self) -> None:
        ...
        from daw_agents.workers.celery_app import CeleryConfig, create_celery_app
...
class TestTaskExecution:
    ...
    def test_tasks_use_base_task_with_retry(self) -> None:
        ...
        from daw_agents.workers.tasks import (
            BaseTaskWithRetry,
            run_executor,
            run_planner,
            run_validator,
...
class TestBaseTaskWithRetry:
    ...
    def test_base_task_autoretry_for_exception(self) -> None:
        ...
        from daw_agents.workers.tasks import BaseTaskWithRetry
    ...
    def test_base_task_max_retries_from_policy(self) -> None:
        ...
        from daw_agents.workers.tasks import DEFAULT_RETRY_POLICY, BaseTaskWithRetry
