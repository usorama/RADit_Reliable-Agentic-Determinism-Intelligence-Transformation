"""
Clerk Authentication module for DAW Server.
...
Example usage with middleware:
    from daw_server.auth import ClerkConfig, ClerkAuthMiddleware
...
Example usage with dependency injection:
    from daw_server.auth import ClerkConfig, ClerkUser, get_current_user
...
from daw_server.auth.dependencies import get_current_user, optional_current_user
